...
/*     15-0 bits are used to identify the function within the library */
/**********************************************************************/
#define IMG_RGB_TO_Y_FXN_ID  		  0x01020069 /*Added by Pramod */
...
/* Function call : IMG_conv_5�5_i8_c8s(const unsigned char * restrict in_data, unsigned char *
 restrict out_data, int cols, const char * restrict mask, int shift)*/
typedef struct IMG_conv_5x5_i8_c8s_Params {
	unsigned int in_data_InArrID1;
	unsigned int out_data_OutArrID1;
	int width;
	int pitch;
...
//)
typedef struct IMG_thr_gt2max_8_Params {
	unsigned int indata_InArrID1;
	unsigned int outdata_OutArrID1;
	int Col;
	int Row;
	int threshold;
} IMG_thr_gt2max_8_Params;
...
//    unsigned char       threshold                /*  Threshold value     */
//);
typedef struct IMG_thr_le2min_8_Params {
	unsigned int indata_InArrID1;
	unsigned int outdata_OutArrID1;
	int Col;
	int Row;
	int threshold;
} IMG_thr_le2min_8_Params;
...
//    unsigned char       threshold                /*  Threshold value     */
//);
typedef struct IMG_thr_le2thr_8_Params {
	unsigned int indata_InArrID1;
	unsigned int outdata_OutArrID1;
	int Col;
	int Row;
