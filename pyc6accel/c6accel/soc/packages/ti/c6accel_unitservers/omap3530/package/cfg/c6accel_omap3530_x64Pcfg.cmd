...
MEMORY {
   ...
   DDRALGHEAP  : origin = 0x87400000,  len = 0x900000
   DDR2        : origin = 0x87d00000,  len = 0x300000
   DSPLINKMEM  : origin = 0x87301000,  len = 0xff000
   RESET_VECTOR : origin = 0x87300000, len = 0x1000
